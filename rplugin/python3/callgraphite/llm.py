...
class LLMClient:
    ...
    def _build_analysis_prompt(self, source: str) -> List[Dict[str, str]]:
        ...
        return [
            ...
            1. Function calls made within the code
            2. Global variables accessed
            ...
            Respond in JSON format with the following structure:
            {
                ...
                "key_operations": ["description1", "description2"],
                "summary": "Overall description of what the function does",
                "data_flow": "Description of how data flows through this function"
            }
            """}, 
        ...
        try:
            ...
            for line in lines:
                ...
                if "function call" in line.lower():
                    ...
                    if current_section in ["function_calls", "global_vars", "key_operations"] and (line.startswith("-") or line.startswith("*")):
                        item = line[1:].strip()
